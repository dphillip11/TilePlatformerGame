function LevelMaker(columns, rows)
    ...
    --             tileMap[x][y+1] = Tile(x,y+1,2)
    --             if math.random(0,15)>14 then 
    --                 tileMap[x][y+1] = Tile(x,y+1,4)
    --                 tileMap[x-1][y+1] = Tile(x-1,y+1,4)
    --             end
    --         end
    --         if tileMap[x][y] == 0 then 
    --             if math.random(1,40) == 10 then
    --                 tileMap[x][y] = Tile(x,y,5)
    --             end
    --         end
    --     end
    -- end
    -- tileMap[8][rows -3] = Tile(8,rows -3,5)
    -- tileMap[5][rows -3] = Tile(5,rows -3,5)
    -- tileMap[1][rows -3] = Tile(1,rows -3,5)
    ...
    -- for x = 2, columns - 1 do
    --     for y = 1, rows - 1 do
    --         if tileMap[x][y] == 0 and tileMap[x][y+1] ~= 0 and tileMap[x][y+1].type == '5' then
