...
function Level:collision(object)
    ...
    if object.dy > 0 then
        ...
        local indices = TileIndex{object.y + object.height + 2, object.x, object.x + object.width}
    ...
    if object.dy < 0 then
        ...
        local indices = TileIndex{object.y-2, object.x, object.x + object.width}
    ...
    if object.dx < 0 then
        ...
        local indices = TileIndex{object.x + 2, object.y+3, object.y + object.height - 3}
    ...
    if object.dx > 0 then
        ...
        local indices = TileIndex{object.x + object.width - 2, object.y+3, object.y + object.height - 3}
